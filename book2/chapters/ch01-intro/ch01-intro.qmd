...
citation:
    page: "1-14"
    doi: "10.1007/978-3-031-95365-1_1"
---
...
methods are useful when dealing with a large number of
...
5 is useful in scenarios with complex and high-dimensional
data.
...
the "opaque" nature of many ML models, which can —and actually does—
...
The aforementioned techniques are essential to understand why a certain decision has
...
of unstructured data [@Oliveira_Song_Saqr_López-Pernas_2025]. LLMs can extract meaningful patterns from text and synthesize
...
for precision education. One  promising direction is the
