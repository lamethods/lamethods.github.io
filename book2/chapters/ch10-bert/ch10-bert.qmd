...
seqdplot(seq_human, ncol = 5) 
seqdplot(seq_ai, ncol = 5)
```

```{r, fig.width=10, fig.height=6, dpi = 900, echo = FALSE, eval = TRUE, message = FALSE}
...
seq_human <- seqdef(wider_human, 2:ncol(wider_human))
seq_ai <- seqdef(wider_ai, 2:ncol(wider_ai))
layout(matrix(c(1, 2, 3, 3), ncol = 2, byrow = T), heights = c(6, 3))
par(mar=c(0,2.5,3,0))
seqdplot(seq_human, use.layout = F, main = "Human", legend.prop = 0,  cex.axis = 1.5, cex.main=2) 
seqdplot(seq_ai, use.layout = F, main = "RoBERTa", legend.prop = 0,  cex.axis = 1.5, cex.main=2)
seqlegend(seq_ai, ncol = 5, cex = 1.4, position = "center", bty = "n", inset = c(0,0,0,0))
```
