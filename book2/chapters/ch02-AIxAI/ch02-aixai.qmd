...
Artificial intelligence (AI) has a long and rich history in education. 
In fact, AI in education predates several other technologies and
disciplines, e.g., online learning. Among the first examples of
AI applications in education is the creation of the
...
However, it was not until the early 1980s when the field of AI in education 
saw its major milestone with the launch of the
...
using AI and machine learning as well as continuous
...
bias a significant challenge. XAI emerges as a
...
In education, intrinsically explainable algorithms are 
...
for users’ evaluative judgment is greater
