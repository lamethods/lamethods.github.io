---
title: "Chapter 16. Community Detection in Learning Networks Using R"
author: 
...
affiliations:
  ...
  - id: "*"
    name: "Corresponding author: Ángel Hernández-García, `angel.hernandez@upm.es`"
format:
  pdf:
    keep-tex: true
...
```
![Interactive visualization of the simplified version of the Replies data set using `visNetwork`](visnetwork.png){#fig-visnetwork width='4in'}
...
In the previous visualization, the legend moves when we zoom in or out,
or drag the graph. A possible workaround to fix the legend is to use the
`htmlwidgets` library [@Yetman_2022]. The final result of the interactive
visualization is shown in @fig-htmlwidgets.
...
![Interactive visualization of the simplified version of the Replies data set using `networkD3`](networkd3.png){#fig-htmlwidgets width='4in'}
