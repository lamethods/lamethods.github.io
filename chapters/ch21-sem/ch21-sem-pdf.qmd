...
affiliations:
  ...
  - id: "*"
    name: "Corresponding author: Joran Jongerling `j.jongerling@tilburguniversity.edu`"
crossref:
  fig-title: '**Figure**'
  fig-labels: arabic
  title-delim: "**.**"
...
variables, you would need about (20 factor loadings + 20 intercepts + 20
error-variances) \* 10 = 600 cases) and multiply that by 2 to also have
...
large to estimate 20 intercepts, 20 loadings, 20 unique variances, and
